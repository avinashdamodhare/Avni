...
namespace Avni
{
    ...
    {
        m_pVertexShader = SINGLETONMANAGER->GetRenderer()->CreateShader("BasicShader",SHADERTYPE_VERTEX);
        m_pPixelShader  = SINGLETONMANAGER->GetRenderer()->CreateShader("BasicShader",SHADERTYPE_PIXEL);
    }
